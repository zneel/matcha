 ...
 */
const confirmUser = confirmationHash => db.query("UPDATE matcha.user SET confirm_email_token = null, is_activated = true WHERE confirm_email_token = $1", [confirmationHash]);
 ...
 */
const resetPassword = (resetPasswordHash, password) => db.query("UPDATE matcha.user SET reset_password_token = null, password = $1 WHERE reset_password_token = $2", [password. resetPasswordHash]);
